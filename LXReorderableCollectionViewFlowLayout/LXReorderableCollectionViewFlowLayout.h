...
- (void)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout panOccurred:(UIPanGestureRecognizer *)panGestureRecognizer withCurrentView:(UIView *)currentView;
